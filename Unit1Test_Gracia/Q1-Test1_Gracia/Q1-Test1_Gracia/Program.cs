...
namespace Q1_Test1_Gracia
{
    internal class Program
    {
        //author: Geoff - with Given code 
        //purpose add a divison case 
        // limits: keeping the other code
        ...
        start:
            ...
            switch (sDifficulty.ToLower())
            {
                case "easy":
                    ...
                    {
                        Console.WriteLine("Congrats David! You get the wonderful opportunity to go to Hard mode instantly!");
                        goto case "hard";
                    }
                    break;
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                // added 4 total cases: 0 = add, 1 = sub, 2 = div, else multiply
                nOp = rand.Next(0, 4);

                val1 = rand.Next(0, (int)nMaxRange) + nMaxRange;
                val2 = rand.Next(0, (int)nMaxRange);
                ...
                //added division instance if the nOp is 2
                else if (nOp == 2)
                {
                    nAnswer = val1 / val2;
                    //added rounding
